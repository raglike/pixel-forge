// PixelForge Animation Template Library
// Built-in animation templates for common character animations
  ...
  attack: {
    ...
    templates: {
      ...
      "attack-6f": {
        ...
        events: [
          { frame: 3, type: 'sound', value: 'swing' },
          { frame: 4, type: 'effect', value: 'impact' }
        ]
      },
      "attack-8f": {
        name: '攻击 (8帧)',
        description: '超精细8帧攻击动画',
        frames: 8,
        loop: false,
        duration: 80,
        suggestedRes: 48,
        loopFrame: null,
        events: [
          { frame: 4, type: 'sound', value: 'charge' },
          { frame: 5, type: 'sound', value: 'swing' },
          { frame: 6, type: 'effect', value: 'slash' }
        ]
      }
    }
  },
    ...
    templates: {
      ...
      "hurt-6f": {
        ...
        events: [
          { frame: 0, type: 'shake', value: 'strong' },
          { frame: 0, type: 'flash', value: 'white' },
          { frame: 5, type: 'state', value: 'recover' }
        ]
      }
    }
  },
    ...
    templates: {
      ...
      "death-8f": {
        ...
        events: [
          ...
          { frame: 0, type: 'shake', value: 'strong' },
          { frame: 0, type: 'flash', value: 'red' },
          { frame: 4, type: 'state', value: 'fallen' },
          { frame: 7, type: 'fade', value: 'out' }
        ]
      }
    }
  },
...
const STATE_MACHINE_PRESETS = {
  // 基础状态机 - 适合平台游戏
  platformer: {
    name: '平台跳跃',
    description: '适合平台跳跃游戏的状态机',
    initial: 'idle',
    states: ['idle', 'walk', 'run', 'jump', 'hurt', 'death'],
    transitions: [
  ...
  rpg: {
    ...
    initial: 'idle',
    states: ['idle', 'walk', 'run', 'attack', 'cast', 'hurt', 'death'],
    transitions: [
      { from: 'idle', to: 'walk', event: 'move', condition: null },
...
function getStateMachinePresets() {
...
function getStateMachinePresetById(id) {
  return STATE_MACHINE_PRESETS[id] || null;
}

// Export
window.ANIMATION_TEMPLATES = ANIMATION_TEMPLATES;
window.STATE_MACHINE_PRESETS = STATE_MACHINE_PRESETS;
...
window.getAnimationCategories = getCategories;
window.getStateMachinePresets = getStateMachinePresets;
window.getStateMachinePresetById = getStateMachinePresetById;
